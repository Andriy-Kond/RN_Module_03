...
export const CreatePhotoBtn = ({ permissionCamera, buttonStyle }) => {
	const permissionMainColor = "#fff";
	const permissionSecondColor = "#BDBDBD";

	const disPermissionMainColor = "rgba(255, 255, 255, 0.30)";
	const disPermissionSecondColor = "#fff";
		...
		<View style={buttonStyle}>
			<Svg
				...
				<Circle
					...
					cy="30"
					r="30"
					fill={permissionCamera ? permissionMainColor : disPermissionMainColor}
				/>
				<G clip-path="url(#clip0_32_29)">
					<Path
						...
						fill={
							permissionCamera
								? permissionSecondColor
								: disPermissionSecondColor
						}
					/>
					<Path
